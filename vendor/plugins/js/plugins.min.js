((t, e) => {
	...
	try {
		k.apply((e = a.call(o.childNodes)), o.childNodes),
			e[o.childNodes.length].nodeType;
	} catch (nt) {
		k = {
			apply: function (t, e) {
				lt.apply(t, a.call(e));
	...
	function O(t, e, i, n) {
		...
		if (!n && (Mt(e), (e = e || E), S)) {
			...
			if (!(pt[t + " "] || (d && d.test(t)))) {
				if (((c = t), (u = e), 1 === h && (bt.test(t) || yt.test(t)))) {
					for (
						((u = (St.test(t) && Dt(e.parentNode)) || e) == e && m.scope) ||
							((s = e.getAttribute("id"))
	...
	function Mt(t) {
		var t = t ? t.ownerDocument || t : o;
		return (
			t != E &&
				9 === t.nodeType &&
				t.documentElement &&
				((n = (E = t).documentElement),
				(S = !T.isXMLDoc(E)),
				(at = n.matches || n.webkitMatchesSelector || n.msMatchesSelector),
				n.msMatchesSelector &&
					o != E &&
					(t = E.defaultView) &&
					t.top !== t &&
					t.addEventListener("unload", kt),
				(m.getById = Ot(function (t) {
					return (
						(n.appendChild(t).id = T.expando),
						!E.getElementsByName || !E.getElementsByName(T.expando).length
					);
				})),
				(m.disconnectedMatch = Ot(function (t) {
					return at.call(t, "*");
				})),
				(m.scope = Ot(function () {
					return E.querySelectorAll(":scope");
				})),
				(m.cssHas = Ot(function () {
					try {
					...
					return t === e
						...
						: !t.compareDocumentPosition - !e.compareDocumentPosition ||
								...
								(!m.sortDetached && e.compareDocumentPosition(t) === i)
									? t === E || (t.ownerDocument == o && O.contains(o, t))
										? -1
										: e === E || (e.ownerDocument == o && O.contains(o, e))
										? 1
										: rt
										? _.call(rt, t) - _.call(rt, e)
										: 0
									: 4 & i
									? -1
									: 1);
	...
	(O.contains = function (t, e) {
		return (t.ownerDocument || t) != E && Mt(t), T.contains(t, e);
	}),
	(O.attr = function (t, e) {
		(t.ownerDocument || t) != E && Mt(t);
		var i = w.attrHandle[e.toLowerCase()],
			i = i && $.call(w.attrHandle, e.toLowerCase()) ? i(t, e, !S) : void 0;
	...
	((w = T.expr =
		{
			...
			pseudos: {
				...
				lang: l(function (i) {
					return (
						wt.test(i || "") || O.error("unsupported lang: " + i),
				...
				checked: function (t) {
					return (
						(b(t, "input") && !!t.checked) || (b(t, "option") && !!t.selected)
					);
				},
				selected: function (t) {
				...
				last: zt(function (t, e) {
					return [e - 1];
				}),
				eq: zt(function (t, e, i) {
					return [i < 0 ? i + e : i];
				}),
				even: zt(function (t, e) {
	...
	function jt(t, e) {
		...
		return e ? s.length : s ? O.error(t) : ht(t, a).slice(0);
	}
	function Rt(t) {
		...
		return (
			...
			l(function (t, e, i, n) {
				var o,
					...
					d = !p || (!t && f) ? h : Ft(h, l, p, i, n);
				if ((m ? m(d, (a = v || (t ? p : u || g) ? [] : e), i, n) : (a = d), g))
					for (o = Ft(a, c), g(o, [], i, n), r = o.length; r--; )
						(s = o[r]) && (a[c[r]] = !(d[c[r]] = s));
				if (t) {
					if (v || p) {
						if (v) {
						...
						for (r = a.length; r--; )
							(s = a[r]) &&
								-1 < (o = v ? _.call(t, s) : l[r]) &&
								(t[o] = !(e[o] = s));
					}
				} else (a = Ft(a === e ? a.splice(u, a.length) : a)), v ? v(null, e, a, n) : k.apply(e, a);
			})
		);
	}
	function Wt(t, e) {
			...
			for (i = (e = e || jt(t)).length; i--; )
				((s = (function t(e) {
					for (
						...
						if ((i = w.relative[e[l].type])) h = [Nt(qt(h), i)];
						else {
			...
			(s = dt(
				...
				(n = function (t, e, i, n, o) {
					...
					for (
						...
						if (b && r) {
							for (
								s = 0, e || r.ownerDocument == E || (Mt(r), (i = !S));
								(a = g[s++]);
	...
	function $t(t, e, i, n) {
		...
		if (((i = i || []), 1 === u.length)) {
			if (
				...
				if (!(e = (w.find.ID(s.matches[0].replace(h, p), e) || [])[0]))
					return i;
				c && (e = e.parentNode), (t = t.slice(r.shift().value.length));
			}
			for (
				o = xt.needsContext.test(t) ? 0 : r.length;
				...
				if (
					(l = w.find[a]) &&
					(n = l(
						s.matches[0].replace(h, p),
						(St.test(r[0].type) && Dt(e.parentNode)) || e
					))
				) {
					if ((r.splice(o, 1), (t = n.length && Rt(r)))) break;
					return k.apply(i, n), i;
				}
		}
		return (
			(c || Wt(t, u))(n, e, !S, i, !e || (St.test(t) && Dt(e.parentNode)) || e),
			i
		);
	}
	(Pt.prototype = w.filters = w.pseudos),
		(w.setFilters = new Pt()),
		(m.sortStable = A.split("").sort(ft).join("") === A),
		Mt(),
		(m.sortDetached = Ot(function (t) {
	...
	var Ut = T.expr.match.needsContext,
		Qt = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
	function Yt(t, i, n) {
		return y(i)
	...
	(T.filter = function (t, e, i) {
		...
		T.fn.extend({
			...
			filter: function (t) {
				return this.pushStack(Yt(this, t || [], !1));
			},
			not: function (t) {
				return this.pushStack(Yt(this, t || [], !0));
			},
			is: function (t) {
				return !!Yt(
					this,
					"string" == typeof t && Ut.test(t) ? T(t) : t || [],
					!1
				).length;
			},
		});
	...
	(T.Callbacks = function (n) {
		...
		var r,
			...
			h = {
				...
				fireWith: function (t, e) {
					return (
						a ||
							((e = [t, (e = e || []).slice ? e.slice() : e]), c.push(e), r) ||
							o(),
						this
					);
				},
		...
		T.extend({
					...
					s = {
						...
						then: function (e, i, n) {
									...
									function t() {
										...
										if (!(o < l)) {
											...
											(e =
												...
												y(e)
													? a
														? e.call(t, c(l, r, te, a), c(l, r, ee, a))
														: (l++,
														  e.call(
																t,
																c(l, r, te, a),
																c(l, r, ee, a),
																c(l, r, te, r.notifyWith)
														  ))
													: (s !== te && ((i = void 0), (n = [t])),
													  (a || r.resolveWith)(i, n));
										}
							...
							return T.Deferred(function (t) {
								r[0][3].add(c(0, t, y(n) ? n : te, t.notifyWith)),
									r[1][3].add(c(0, t, y(e) ? e : te)),
									r[2][3].add(c(0, t, y(i) ? i : ee));
							}).promise();
						},
						promise: function (t) {
			...
			when: function (t) {
				...
				if (
					i <= 1 &&
					(ie(t, s.done(e(n)).resolve, s.reject, !i),
					"pending" === s.state() || y(r[n] && r[n].then))
				)
					return s.then();
				for (; n--; ) ie(r[n], e(n), s.reject);
				return s.promise();
			},
		});
	...
	function u(t, e, i, n, o, r, s) {
		var a = 0,
			l = t.length,
			c = null == i;
		if ("object" === Y(i)) for (a in ((o = !0), i)) u(t, e, a, i[a], !0, r, s);
		else if (
			void 0 !== n &&
			((o = !0),
			y(n) || (s = !0),
	...
	function pe(t, e, i) {
		...
		if (void 0 === i && 1 === t.nodeType)
			if (
				((n = "data-" + e.replace(de, "-$&").toLowerCase()),
	...
	function _e(t, e, i, n) {
		...
		return (
			i &&
				((u = +u || +l || 0), (o = i[1] ? u + (i[1] + 1) * i[2] : +i[2]), n) &&
	...
	function g(t, e) {
		var i =
			void 0 !== t.getElementsByTagName
				...
				: [];
		return void 0 === e || (e && b(t, e)) ? T.merge([t], i) : i;
	}
	function Se(t, e) {
	...
	function Ae(t, e, i, n, o) {
		for (
			...
			if ((r = t[d]) || 0 === r)
				if ("object" === Y(r)) T.merge(h, r.nodeType ? [r] : r);
				else if (ke.test(r)) {
					for (
		...
		for (u.textContent = "", d = 0; (r = h[d++]); )
			if (n && -1 < T.inArray(r, n)) o && o.push(r);
				...
				((l = ye(r)), (s = g(u.appendChild(r), "script")), l && Se(s), i)
			)
	...
	(T.event = {
					...
					(h = p = (d = Ie.exec(t[l]) || [])[1]),
						...
						h &&
							...
							(u = a[h]) ||
								...
								c.setup && !1 !== c.setup.call(e, n, d, s)) ||
		...
		dispatch: function (t) {
			...
			if (
				...
				for (
					r = T.event.handlers.call(this, a, t), e = 0;
		...
		special: {
			...
			click: {
				setup: function (t) {
					t = this || t;
					return (
						Ce.test(t.type) && t.click && b(t, "input") && De(t, "click", !0),
						!1
					);
				},
				trigger: function (t) {
		...
		T.each({ focus: "focusin", blur: "focusout" }, function (n, o) {
			...
			(T.event.special[n] = {
				setup: function () {
					...
					(t = v.get(this, o)) || this.addEventListener(o, r),
						v.set(this, o, (t || 0) + 1);
				},
				trigger: function () {
					return De(this, n), !0;
		...
		if (1 === e.nodeType) {
			if (v.hasData(t) && (r = v.get(t).events))
				for (o in (v.remove(e, "handle events"), r))
					for (i = 0, n = r[o].length; i < n; i++) T.event.add(e, o, r[o][i]);
	...
	function He(i, n, o, r) {
		...
		var t,
			...
			p = n[0],
			f = y(p);
		if (f || (1 < h && "string" == typeof p && !m.checkClone && Pe.test(p)))
			return i.each(function (t) {
				var e = i.eq(t);
				f && (n[0] = p.call(this, t, e.html())), He(e, n, o, r);
			});
		if (
			h &&
			((e = (t = Ae(n, i[0].ownerDocument, !1, i, r)).firstChild),
			1 === t.childNodes.length && (t = e),
			e || r)
		) {
			for (a = (s = T.map(g(t, "script"), Ne)).length; u < h; u++)
				(l = t),
					u !== d &&
						((l = T.clone(l, !0, !0)), a) &&
						T.merge(s, g(l, "script")),
					o.call(i[u], l, u);
			if (a)
				for (c = s[s.length - 1].ownerDocument, T.map(s, qe), u = 0; u < a; u++)
					(l = s[u]),
						Ee.test(l.type || "") &&
							...
							(l.src && "module" !== (l.type || "").toLowerCase()
								...
								: Q(l.textContent.replace(je, ""), l, c));
		}
		return i;
	}
	function We(t, e, i) {
		for (var n, o = e ? T.filter(e, t) : t, r = 0; null != (n = o[r]); r++)
			i || 1 !== n.nodeType || T.cleanData(g(n)),
				n.parentNode &&
					(i && ye(n) && Se(g(n, "script")), n.parentNode.removeChild(n));
		return t;
	}
	T.extend({
		...
		clone: function (t, e, i) {
			...
			if (
				...
				for (s = g(u), n = 0, o = (r = g(t)).length; n < o; n++)
					(a = r[n]),
			...
			if (e)
				if (i)
					for (r = r || g(t), s = s || g(u), n = 0, o = r.length; n < o; n++)
						Fe(r[n], s[n]);
				else Fe(t, u);
			return 0 < (s = g(u, "script")).length && Se(s, !h && g(t, "script")), u;
		},
		...
		T.fn.extend({
			...
			empty: function () {
				for (var t, e = 0; null != (t = this[e]); e++)
					1 === t.nodeType && (T.cleanData(g(t, !1)), (t.textContent = ""));
				return this;
			},
			clone: function (t, e) {
				return (
				...
				return u(
					...
					function (t) {
						...
						if (
							"string" == typeof t &&
							!Me.test(t) &&
							!f[(Te.exec(t) || ["", ""])[1].toLowerCase()]
						) {
							t = T.htmlPrefilter(t);
							try {
								for (; i < n; i++)
									1 === (e = this[i] || {}).nodeType &&
										(T.cleanData(g(e, !1)), (e.innerHTML = t));
								e = 0;
							} catch (t) {}
						}
		...
		T.each(
			...
			function (t, s) {
				T.fn[t] = function (t) {
					for (var e, i = [], n = T(t), o = n.length - 1, r = 0; r <= o; r++)
	...
	function ni() {
		...
		D &&
			...
			ve.appendChild(Ze).appendChild(D),
			(t = x.getComputedStyle(D)),
			(Ve = "1%" !== t.top),
	...
	var ri = ["Webkit", "Moz", "ms"],
		si = C.createElement("div").style,
		ai = {};
	function li(t) {
		return (
			T.cssProps[t] ||
			...
			(t in si
				...
				: (ai[t] =
						((t) => {
							for (
								var e = t[0].toUpperCase() + t.slice(1), i = ri.length;
								i--;

							)
								if ((t = ri[i] + e) in si) return t;
						})(t) || t))
		);
	}
	...
	function pi(t, e, i, n, o, r) {
		...
		for (; s < 4; s += 2)
			"margin" === i && (c += T.css(t, i + ge[s], !0, o)),
				n
					? ("content" === i && (l -= T.css(t, "padding" + ge[s], !0, o)),
					  "margin" !== i &&
							(l -= T.css(t, "border" + ge[s] + "Width", !0, o)))
					: ((l += T.css(t, "padding" + ge[s], !0, o)),
					  "padding" !== i
							? (l += T.css(t, "border" + ge[s] + "Width", !0, o))
							: (a += T.css(t, "border" + ge[s] + "Width", !0, o)));
		return (
			!n &&
				0 <= r &&
				(l +=
	...
	function fi(t, e, i) {
		...
		return (
			((!m.boxSizingReliable() && o) ||
				(!m.reliableTrDimensions() && b(t, "tr")) ||
				"auto" === s ||
				(!parseFloat(s) && "inline" === T.css(t, "display", !1, n))) &&
				t.getClientRects().length &&
				((o = "border-box" === T.css(t, "boxSizing", !1, n)), (r = a in t)) &&
				(s = t[a]),
			(s = parseFloat(s) || 0) +
				pi(t, e, i || (o ? "border" : "content"), r, n, s) +
				"px"
		);
	}
	...
	T.extend({
		...
		style: function (t, e, i, n) {
			if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
				var o,
					...
					c = t.style;
				if (
					(l || (e = li(a)), (s = T.cssHooks[e] || T.cssHooks[a]), void 0 === i)
				)
			...
			return (
				...
				"normal" ===
					(o =
						void 0 ===
						(o =
							(r = T.cssHooks[e] || T.cssHooks[r]) && "get" in r
								? r.get(t, !0, i)
								: o)
							? ei(t, e, n)
							: o) &&
					e in hi &&
					(o = hi[e]),
				("" === i || i) && ((r = parseFloat(o)), !0 === i || isFinite(r))
					? r || 0
					: o
			);
		},
			...
			T.cssHooks[s] = {
				...
				set: function (t, e, i) {
					var n = $e(t),
						...
						r = (o || i) && "border-box" === T.css(t, "boxSizing", !1, n),
						i = i ? pi(t, s, i, r, n) : 0;
					return (
						r &&
							o &&
							(i -= Math.ceil(
								t["offset" + s[0].toUpperCase() + s.slice(1)] -
									parseFloat(n[s]) -
									pi(t, s, "border", !1, n) -
									0.5
							)),
			...
			(T.cssHooks[o + r] = {
				expand: function (t) {
					for (
						...
						i[o + ge[e] + r] = n[e] || n[e - 2] || n[0];
					return i;
				},
			}),
				"margin" !== o && (T.cssHooks[o + r].set = di);
		}),
		T.fn.extend({
			css: function (t, e) {
				return u(
					...
					function (t, e, i) {
						var n,
							...
							s = 0;
						if (Array.isArray(e)) {
							for (n = $e(t), o = e.length; s < o; s++)
								r[e[s]] = T.css(t, e[s], !1, n);
							return r;
						}
		...
		(((T.Tween = M).prototype = {
			...
			cur: function () {
				...
				return (t && t.get ? t : M.propHooks._default).get(this);
			},
			run: function (t) {
				var e,
				...
				return (
					...
					(i && i.set ? i : M.propHooks._default).set(this),
					this
				);
			},
	...
	function wi(t, e) {
		...
		for (e = e ? 1 : 0; n < 4; n += 2 - e)
			o["margin" + (i = ge[n])] = o["padding" + i] = t;
		return e && (o.opacity = o.width = t), o;
	}
	function xi(t, e, i) {
		for (
			var n,
				o = (P.tweeners[e] || []).concat(P.tweeners["*"]),
				r = 0,
				s = o.length;
			r < s;
			r++
	...
	function P(o, t, e) {
		...
		for (n in g)
			if (
				...
				n !== s && ((g[s] = l), delete g[n]),
				(c = T.cssHooks[s]) && "expand" in c)
			)
				for (n in ((l = c.expand(l)), delete g[s], l))
					n in g || ((g[n] = l[n]), (v[n] = a));
			else v[s] = a;
		for (; u < h; u++)
			if ((i = P.prefilters[u].call(f, o, m, f.opts)))
				return (
					y(i.stop) &&
	...
	(T.Animation = T.extend(P, {
		tweeners: {
			"*": [
				function (t, e) {
					...
					return _e(i.elem, t, me.exec(e), i), i;
				},
			],
		},
		tweener: function (t, e) {
			for (
				var i, n = 0, o = (t = y(t) ? ((e = t), ["*"]) : t.match(L)).length;
				n < o;
				n++
			)
				(i = t[n]),
					(P.tweeners[i] = P.tweeners[i] || []),
					P.tweeners[i].unshift(e);
		},
		prefilters: [
			function (t, e, i) {
				var n,
			...
			stop: function (o, t, r) {
				...
				return (
					...
					this.each(function () {
						...
						else for (e in n) n[e] && n[e].stop && yi.test(e) && s(n[e]);
						for (e = i.length; e--; )
							i[e].elem !== this ||
								(null != o && i[e].queue !== o) ||
		...
		(r = C.createElement("select").appendChild(C.createElement("option"))),
		(s.type = "checkbox"),
		(m.checkOn = "" !== s.value),
			...
			propHooks: {
				tabIndex: {
					get: function (t) {
						...
						return e
							? parseInt(e, 10)
							: Ei.test(t.nodeName) || (Si.test(t.nodeName) && t.href)
							? 0
							: -1;
					},
				},
		...
		T.fn.extend({
			addClass: function (e) {
				...
				return y(e)
					...
					? this.each(function () {
							if (
								((n = Ai(this)), (i = 1 === this.nodeType && " " + ki(n) + " "))
							) {
								for (r = 0; r < t.length; r++)
									(o = t[r]), i.indexOf(" " + o + " ") < 0 && (i += o + " ");
								(s = ki(i)), n !== s && this.setAttribute("class", s);
							}
					  })
					: this;
			},
				...
				return y(e)
					...
					? (t = Ii(e)).length
						? this.each(function () {
								if (
									((n = Ai(this)),
									(i = 1 === this.nodeType && " " + ki(n) + " "))
								) {
									for (r = 0; r < t.length; r++)
										for (o = t[r]; -1 < i.indexOf(" " + o + " "); )
											i = i.replace(" " + o + " ", " ");
									(s = ki(i)), n !== s && this.setAttribute("class", s);
								}
						  })
			...
			toggleClass: function (e, i) {
				...
				return y(e)
					...
					: ((t = Ii(e)),
					  this.each(function () {
							if (a)
								for (r = T(this), o = 0; o < t.length; o++)
									(n = t[o]), r.hasClass(n) ? r.removeClass(n) : r.addClass(n);
							else
								(void 0 !== e && "boolean" != s) ||
			...
			hasClass: function (t) {
				for (var e, i = 0, n = " " + t + " "; (e = this[i++]); )
					if (1 === e.nodeType && -1 < (" " + ki(Ai(e)) + " ").indexOf(n))
						return !0;
				return !1;
			},
		});
			...
			T.extend({
				valHooks: {
					...
					select: {
						...
						set: function (t, e) {
							for (
								var i, n, o = t.options, r = T.makeArray(e), s = o.length;
								s--;
			...
			(T.extend(T.event, {
				trigger: function (t, e, i, n) {
					...
					if (
						...
						if (!n && !c.noBubble && !R(i)) {
							for (
								s = c.delegateType || d, Pi.test(s + d) || (f = f.parentNode);
								f;
								f = f.parentNode
							)
								h.push(f), (r = f);
						...
						for (o = 0; (f = h[o++]) && !t.isPropagationStopped(); )
							(u = f),
								...
								(l = a && f[a]) &&
									l.apply &&
									ce(f) &&
									((t.result = l.apply(f, e)), !1 === t.result) &&
									t.preventDefault();
						return (
							(t.type = d),
							n ||
						...
						n
							? (f.ifModified &&
									((i = _.getResponseHeader("Last-Modified")) &&
										(T.lastModified[c] = i),
									(i = _.getResponseHeader("etag"))) &&
									(T.etag[c] = i),
							  204 === t || "HEAD" === f.type
									? (a = "nocontent")
									: 304 === t
									? (a = "notmodified")
									: ((a = s.state), (o = s.data), (n = !(r = s.error))))
							: ((r = a), (!t && a) || ((a = "error"), t < 0 && (t = 0))),
						(_.status = t),
						(_.statusText = (e || a) + ""),
						n ? v.resolveWith(m, [o, a, _]) : v.rejectWith(m, [_, a, r]),
						_.statusCode(b),
						(b = void 0),
						p && g.trigger(n ? "ajaxSuccess" : "ajaxError", [_, f, n ? o : r]),
						y.fireWith(m, [_, a]),
						p &&
		...
		on =
			...
			(T.fn.load = function (t, e, i) {
				var n,
					...
					a = t.indexOf(" ");
				return (
					-1 < a && ((n = ki(t.slice(a))), (t = t.slice(0, a))),
					y(e)
						? ((i = e), (e = void 0))
					...
					"static" === a && (t.style.position = "relative"),
						...
						(a =
							...
							-1 < (n + s).indexOf("auto")
								...
								: ((o = parseFloat(n) || 0), parseFloat(s) || 0)),
						null != (e = y(e) ? e.call(t, i, T.extend({}, r)) : e).top &&
							(c.top = e.top - r.top + o),
	...
	((t, e) => {
		...
		let n = new Map(),
			...
			t = (n) => {
				var t = () => {
					...
					if (i) {
						let t = n.NAME,
							e = i.fn[t];
						(i.fn[t] = n.jQueryInterface),
							(i.fn[t].Constructor = n),
							(i.fn[t].noConflict = () => ((i.fn[t] = e), n.jQueryInterface));
					}
				};
			...
			V = (n, o, t = !0) => {
				if (t) {
					...
					let e = !1,
						i = ({ target: t }) => {
							t === o && ((e = !0), o.removeEventListener(R, i), c(n));
						};
				...
				var c,
					...
					o = t
						...
						: ((c = n),
						  ...
						  function t(e) {
								return (
									at(e, { delegateTarget: c }),
									t.oneOff && f.off(c, e.type, u),
									u.apply(c, [e])
								);
						  });
				(o.delegationSelector = t ? r : null),
					(o.callable = e),
					(o.oneOff = a),
					(s[(o.uidEvent = l)] = o),
						...
						if (i)
							for (let t of Object.keys(r)) {
								...
								var m,
									g,
									v = d[p] || {};
								for ([m, g] of Object.entries(v))
									m.includes(f) &&
										rt(h, d, p, g.callable, g.delegationSelector);
							}
						for (let [e, i] of Object.entries(s)) {
							let t = e.replace(X, "");
							(o && !l.includes(t)) ||
								rt(a, r, n, i.callable, i.delegationSelector);
						}
					} else Object.keys(s).length && rt(a, r, n, e, t ? c : null);
				}
			},
			trigger(t, e, i) {
				...
				n = at(new Event(e, { bubbles: r, cancelable: !0 }), i);
				return (
					a && n.preventDefault(),
					s && t.dispatchEvent(n),
		...
		function at(i, n = {}) {
			for (let [t, e] of Object.entries(n))
				try {
					...
					Object.defineProperty(i, t, { configurable: !0, get: () => e });
				}
			return i;
		}
		function lt(e) {
		...
		let u = {
			...
			getDataAttributes(e) {
				...
				var i,
					n = {};
				for (i of Object.keys(e.dataset).filter(
					(t) => t.startsWith("bs") && !t.startsWith("bsConfig")
				)) {
					let t = i.replace(/^bs/, "");
					n[(t = t.charAt(0).toLowerCase() + t.slice(1, t.length))] = lt(
						e.dataset[i]
					);
				}
				return n;
		...
		class ut {
			...
			_mergeConfigObj(t, e) {
				...
				return {
					...
					...("object" == typeof i ? i : {}),
					...(s(e) ? u.getDataAttributes(e) : {}),
					...("object" == typeof t ? t : {}),
				};
			}
			_typeCheckConfig(i, t = this.constructor.DefaultType) {
				for (var [n, o] of Object.entries(t)) {
					let t = i[n],
						e = s(t)
							? "element"
							: null == (r = t)
					...
					if (!new RegExp(o).test(e))
						throw new TypeError(
							`${this.constructor.NAME.toUpperCase()}: Option "${n}" provided type "${e}" but expected type "${o}".`
						);
				}
				var r;
			}
		...
		let ht = (e) => {
			...
			dt = (e, i = "hide") => {
				let t = "click.dismiss" + e.EVENT_KEY,
					n = e.NAME;
		...
		class pt extends e {
			...
			close() {
				var t;
				f.trigger(this._element, "close.bs.alert").defaultPrevented ||
		...
		f.on(document, "click.bs.button.data-api", ft, (t) => {
			t.preventDefault();
		...
		let bt = ".bs.carousel",
			...
			Et = ".active",
			St = ".carousel-item",
			kt = (Et, St, { ArrowLeft: wt, ArrowRight: p }),
			At = {
				interval: 5e3,
				keyboard: !0,
				pause: "hover",
		...
		class Ot extends e {
			...
			_maybeEnableCycle() {
				this._config.ride &&
					(this._isSliding
						? f.one(this._element, xt, () => this.cycle())
						: this.cycle());
			}
			to(t) {
				var e,
				...
				t > i.length - 1 ||
					t < 0 ||
					(this._isSliding
						? f.one(this._element, xt, () => this.to(t))
						: (e = this._getItemIndex(this._getActive())) !== t &&
						  ((e = e < t ? _t : d), this._slide(e, i[t])));
			}
			dispose() {
			...
			_addTouchEventListeners() {
				for (let t of h.find(".carousel-item img", this._element))
			...
			_setActiveIndicatorElement(t) {
				...
				this._indicatorsElement &&
					((e = h.findOne(Et, this._indicatorsElement)).classList.remove(Tt),
					e.removeAttribute("aria-current"),
					(e = h.findOne(
						`[data-bs-slide-to="${t}"]`,
						this._indicatorsElement
					))) &&
					(e.classList.add(Tt), e.setAttribute("aria-current", "true"));
			}
			_updateInterval() {
			...
			_slide(e, a = null) {
				if (!this._isSliding) {
					let o = this._getActive(),
						r = e === _t,
						s = a || U(this._getItems(), o, r, this._config.wrap);
					if (s !== o) {
						let i = this._getItemIndex(s),
							n = (t) =>
						...
						if (!n("slide.bs.carousel").defaultPrevented && o && s) {
							a = Boolean(this._interval);
							this.pause(),
								(this._isSliding = !0),
								this._setActiveIndicatorElement(i),
								(this._activeElement = s);
							let t = r ? "carousel-item-start" : "carousel-item-end",
								e = r ? "carousel-item-next" : "carousel-item-prev";
							s.classList.add(e),
								W(s),
								o.classList.add(t),
								s.classList.add(t),
								this._queueCallback(
									() => {
										s.classList.remove(t, e),
											s.classList.add(Tt),
											o.classList.remove(Tt, e, t),
											(this._isSliding = !1),
											n(xt);
									},
									o,
			...
			_getItems() {
				return h.find(St, this._element);
			}
			_clearInterval() {
				this._interval &&
			...
			_directionToOrder(t) {
				return l() ? (t === p ? d : _t) : t === p ? _t : d;
			}
			_orderToDirection(t) {
				return l() ? (t === d ? p : wt) : t === d ? wt : p;
			}
			static jQueryInterface(e) {
				return this.each(function () {
					var t = Ot.getOrCreateInstance(this, e);
					if ("number" != typeof e) {
						if ("string" == typeof e) {
							if (void 0 === t[e] || e.startsWith("_") || "constructor" === e)
								throw new TypeError(`No method named "${e}"`);
		...
		f.on(
			...
			function (t) {
				...
				e &&
					e.classList.contains(Ct) &&
					(t.preventDefault(),
					(t = Ot.getOrCreateInstance(e)),
			...
			f.on(window, "load.bs.carousel.data-api", () => {
				var t;
				for (t of h.find('[data-bs-ride="carousel"]'))
		...
		let Lt = "show",
			m = "collapse",
			zt = "collapsing",
			Dt = (m, m, '[data-bs-toggle="collapse"]'),
			Mt = { parent: null, toggle: !0 },
		...
		class jt extends e {
			constructor(t, e) {
				...
				let n = h.find(Dt);
				for (let i of n) {
					let t = h.getSelectorFromElement(i),
						e = h.find(t).filter((t) => t === this._element);
			...
			show() {
				if (!this._isTransitioning && !this._isShown()) {
					...
					if (
						!(
							((e = this._config.parent
								? this._getFirstLevelChildren(
										...
										.map((t) => jt.getOrCreateInstance(t, { toggle: !1 }))
								: e).length &&
						...
						var i = "scroll" + (t[0].toUpperCase() + t.slice(1));
						this._queueCallback(
							() => {
								(this._isTransitioning = !1),
									this._element.classList.remove(zt),
									this._element.classList.add(m, Lt),
			...
			hide() {
				if (
					...
					this._isShown() &&
					!f.trigger(this._element, "hide.bs.collapse").defaultPrevented
				) {
					let t = this._getDimension();
					(this._element.style[t] =
						...
						W(this._element),
						this._element.classList.add(zt),
						this._element.classList.remove(m, Lt);
			...
			_initializeChildren() {
				if (this._config.parent) {
					let t = this._getFirstLevelChildren(Dt);
					for (var e of t) {
			...
			_getFirstLevelChildren(t) {
				let e = h.find(":scope .collapse .collapse", this._config.parent);
			...
			static jQueryInterface(e) {
				...
				return (
					...
					this.each(function () {
						var t = jt.getOrCreateInstance(this, i);
						if ("string" == typeof e) {
							if (void 0 === t[e])
								throw new TypeError(`No method named "${e}"`);
							t[e]();
		...
		f.on(document, "click.bs.collapse.data-api", Dt, function (t) {
			("A" === t.target.tagName ||
				...
				t.preventDefault();
			for (let t of h.getMultipleElementsFromSelector(this))
		...
		var k = "top",
			...
			Ft = "popper",
			Ht = "reference",
			Wt = L.reduce(function (t, e) {
				return t.concat([e + "-" + z, e + "-" + b]);
			}, []),
			$t = [].concat(L, [Rt]).reduce(function (t, e) {
			...
			Yt = "beforeWrite",
			Xt = "afterWrite",
			Gt = [Bt, "read", Vt, Ut, "main", Qt, Yt, "write", Xt];
		function g(t) {
		...
		function ne(t, e, i) {
			...
			var n = t.getBoundingClientRect(),
				...
				e =
					(e &&
						y(t) &&
						((o = (0 < t.offsetWidth && te(n.width) / t.offsetWidth) || 1),
						(r = (0 < t.offsetHeight && te(n.height) / t.offsetHeight) || 1)),
					(v(t) ? _(t) : window).visualViewport),
				t = !ie() && i,
		...
		function x(t) {
			return (
				(v(t) ? t.ownerDocument : t.document) || window.document
			).documentElement;
		}
		function se(t) {
			return "html" === g(t)
				? t
				: t.assignedSlot || t.parentNode || (Zt(t) ? t.host : null) || x(t);
		}
		function ae(t) {
			return y(t) && "fixed" !== w(t).position ? t.offsetParent : null;
		}
		function le(t) {
			for (
				var e, i = _(t), n = ae(t);
				n &&
				((e = n), 0 <= ["table", "td", "th"].indexOf(g(e))) &&
				"static" === w(n).position;
			...
			l &&
				...
				(n !== O && ((n !== k && n !== A) || o !== b)) ||
					...
					(u =
						...
						(a ? 1 : -1))));
			var g,
				v = Object.assign({ position: s }, l && me),
				y =
					!0 === c
						? ((n = { x: u, y: h }),
						  (o = _(e)),
			...
			be = {
				...
				effect: function (t) {
					...
					return (
						...
						r && s.addEventListener("resize", i.update, ye),
						function () {
							o &&
								a.forEach(function (t) {
									t.removeEventListener("scroll", i.update, ye);
								}),
								r && s.removeEventListener("resize", i.update, ye);
						}
					);
				},
				data: {},
		...
		function Ee(t) {
			return ne(x(t)).left + Te(t).scrollLeft;
		}
		function Se(t) {
			var t = w(t),
				e = t.overflow;
			return /auto|scroll|overlay|hidden/.test(e + t.overflowY + t.overflowX);
		}
		function ke(t, e) {
			void 0 === e && (e = []);
			var i = (function t(e) {
				...
				n = _(i),
				n = t ? [n].concat(n.visualViewport || [], Se(i) ? i : []) : i,
				i = e.concat(n);
			return t ? i : i.concat(ke(se(n)));
		}
		function Ae(t) {
		...
		function Ie(t, e, i) {
			return e === qt
				? Ae(
						...
						{ width: l, height: a, x: c + Ee(n), y: u })
				  )
				: v(e)
				? (((o = ne((r = e), !1, "fixed" === i)).top = o.top + r.clientTop),
				...
				: Ae(
						...
						(a = -a.scrollTop),
						"rtl" === w(c || l).direction &&
							(s += S(l.clientWidth, c ? c.clientWidth : 0) - n),
		...
		function Le(t, e) {
			var i,
				...
				e = e.padding,
				e = void 0 === e ? 0 : e,
				e = he("number" != typeof e ? e : de(e, L)),
				f = t.rects.popper,
				p = t.elements[p ? (d === Ft ? Ht : Ft) : d],
				c =
					((i = v(p) ? p : p.contextElement || x(t.elements.popper)),
					(p = h),
					(n = c),
					(r =
						"clippingParents" === (h = u)
							? ((s = ke(se((r = i)))),
							  v(
									(o =
										0 <= ["absolute", "fixed"].indexOf(w(r).position) && y(r)
											? le(r)
											: r)
							  )
									? s.filter(function (t) {
											return v(t) && re(t, o) && "body" !== g(t);
									  })
									: [])
							: [].concat(h)),
					(s = [].concat(r, [p])),
					...
					}, Ie(i, h, n))).width = p.right - p.left),
					(p.height = p.bottom - p.top),
					(p.x = p.left),
					(p.y = p.top),
					p),
				u = ne(t.elements.reference),
				h = Oe({
					reference: u,
					element: f,
					strategy: "absolute",
							...
							i =
								...
								(e !== s && m
									? D((i = s)) === Rt
										...
										: ((e = we(i)), [Ce(i), e, Ce(e)])
									: [we(s)]),
							a = [s].concat(i).reduce(function (t, e) {
								return t.concat(
									D(e) === Rt
										? ((i = h),
										  (n = (t = t =
										  ...
										  (s = t.padding),
										  (a = t.flipVariations),
										  (l = void 0 === (t = t.allowedAutoPlacements) ? $t : t),
										  (c = fe(n)),
										  (t = c
												? a
													? Wt
		...
		function Me(e) {
			return [k, I, A, O].some(function (t) {
				return 0 <= e[t];
			});
		}
		var Pe = {
			...
			Ne = {
				...
				fn: function (t) {
					var e,
						...
						h = Le(u, {
							boundary: h.boundary,
							rootBoundary: h.rootBoundary,
							padding: h.padding,
							altBoundary: h.altBoundary,
						}),
						g = D(u.placement),
						v = fe(u.placement),
						y = !v,
						...
						m =
							"function" == typeof m
								? m(Object.assign({}, u.rects, { placement: u.placement }))
								: m,
						m =
							"number" == typeof m
					...
					w &&
						(d &&
							...
							(c = ue(0, x[d], r[d])),
							(r = y
								? x[d] / 2 - e - c - i - m.mainAxis
								: o - c - i - m.mainAxis),
							(o = y
								? -x[d] / 2 + e + c + n + m.mainAxis
								: v + c + n + m.mainAxis),
							(y = (i = u.elements.arrow && le(u.elements.arrow))
								? "y" === b
									? i.clientTop || 0
									: i.clientLeft || 0
								: 0),
							...
							(c = ue(f ? Jt(s, a + r - e - y) : s, a, f ? S(l, v) : l)),
							(w[b] = c),
							(E[b] = c - a)),
						p &&
							((n = "y" == _ ? "height" : "width"),
							...
							(d = i - h["x" === b ? A : I]),
							(r = -1 !== [k, O].indexOf(g)),
							(y = null != (e = null == T ? void 0 : T[_]) ? e : 0),
							(s = r ? o : i - x[n] - C[n] - y + m.altAxis),
							(v = r ? i + x[n] + C[n] - y - m.altAxis : d),
							(a =
								f && r
									? ((c = ue(s, i, (l = v))), l < c ? l : c)
									: ue(f ? s : o, i, f ? v : d)),
							(w[_] = a),
							(E[_] = a - i)),
						(u.modifiersData[t] = E));
								...
								if (He(e, t)) {
									(p.rects = {
										reference:
											...
											(c =
												y(s) &&
												((h = (c = s).getBoundingClientRect()),
												(u = te(h.width) / c.offsetWidth || 1),
												(h = te(h.height) / c.offsetHeight || 1),
												1 !== u || 1 !== h)),
											(u = x(s)),
											(h = ne(e, c, a)),
									...
									for (var i, n, o, r = 0; r < p.orderedModifiers.length; r++)
										!0 !== p.reset
											? ((n = (i = p.orderedModifiers[r]).fn),
											  (o = i.options),
											  "function" == typeof n &&
													(p =
														n({
		...
		var $e = We(),
			Be = We({ defaultModifiers: [be, Re, ve, Kt] }),
			Ve = We({ defaultModifiers: [be, Re, ve, Kt, je, ze, Ne, pe, Pe] });
		let Ue = Object.freeze(
			...
			ni = l() ? "bottom-end" : "bottom-start",
			oi = l() ? "bottom-start" : "bottom-end",
		...
		class T extends e {
			constructor(t, e) {
				super(t, e),
					...
					(this._menu =
						h.next(this._element, ti)[0] ||
						h.prev(this._element, ti)[0] ||
						h.findOne(ti, this._parent)),
			...
			show() {
				if (!a(this._element) && !this._isShown()) {
					...
					if (
						!f.trigger(this._element, "show.bs.dropdown", t).defaultPrevented
					) {
						if (
							(this._createPopper(),
							"ontouchstart" in document.documentElement &&
				...
				return e.classList.contains("dropend")
					...
					: ((t =
							...
							getComputedStyle(this._menu)
								...
								.trim()),
					  e.classList.contains("dropup") ? (t ? ii : ei) : t ? oi : ni);
			}
			_detectNavbar() {
				return null !== this._element.closest(".navbar");
			}
			_getOffset() {
				let e = this._config.offset;
			...
			_selectMenuItem({ key: t, target: e }) {
				var i = h
					...
					.filter((t) => r(t));
				i.length && U(i, e, t === Ge, !i.includes(e)).focus();
			}
			static jQueryInterface(e) {
				return this.each(function () {
			...
			static clearMenus(e) {
				if (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)) {
					...
					for (var i of t) {
						let t = T.getInstance(i);
						var n;
						t &&
							!1 !== t._config.autoClose &&
							((n = (i = e.composedPath()).includes(t._menu)),
			...
			static dataApiKeydownHandler(t) {
				...
				(!n && !i) ||
					...
					(e = this.matches(C)
						...
						: h.prev(this, C)[0] ||
						  h.next(this, C)[0] ||
						  h.findOne(C, t.delegateTarget.parentNode)),
					(i = T.getOrCreateInstance(e)),
					n
						? (t.stopPropagation(), i.show(), i._selectMenuItem(t))
						: i._isShown() && (t.stopPropagation(), i.hide(), e.focus()));
			}
		}
		f.on(document, Ke, C, T.dataApiKeydownHandler),
			f.on(document, Ke, ti, T.dataApiKeydownHandler),
			f.on(document, Ze, T.clearMenus),
			f.on(document, "keyup.bs.dropdown.data-api", T.clearMenus),
			f.on(document, Ze, C, function (t) {
		...
		class yi extends ut {
			...
			deactivate() {
				this._isActive && ((this._isActive = !1), f.off(document, fi));
			}
			_handleFocusin(t) {
				...
				t.target === document ||
					t.target === e ||
					e.contains(t.target) ||
					(0 === (t = h.focusableChildren(e)).length
						? e
			...
			_handleKeydown(t) {
				"Tab" === t.key &&
					(this._lastTabNavDirection = t.shiftKey ? mi : "forward");
			}
		}
		let bi = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
			_i = ".sticky-top",
			wi = "padding-right",
			xi = "margin-right";
		class Ci {
			...
			hide() {
				...
				this._disableOverFlow(),
					this._setElementAttributes(this._element, wi, (t) => t + e),
					this._setElementAttributes(bi, wi, (t) => t + e),
					this._setElementAttributes(_i, xi, (t) => t - e);
			}
			reset() {
				this._resetElementAttributes(this._element, "overflow"),
					this._resetElementAttributes(this._element, wi),
					this._resetElementAttributes(bi, wi),
					this._resetElementAttributes(_i, xi);
			}
			isOverflowing() {
			...
			_applyManipulationCallback(t, e) {
				if (s(t)) e(t);
				else for (var i of h.find(t, this._element)) e(i);
			}
		}
		let E = ".bs.modal",
			Ti = (E, E, "hidden" + E),
			Ei = "show" + E,
			Si = (E, E, E, E, E, E, "modal-open"),
			ki = "modal-static",
		...
		class Oi extends e {
			...
			show(t) {
				this._isShown ||
					this._isTransitioning ||
					f.trigger(this._element, Ei, { relatedTarget: t }).defaultPrevented ||
					((this._isShown = !0),
					(this._isTransitioning = !0),
			...
			_hideModal() {
				(this._element.style.display = "none"),
					...
					(this._isTransitioning = !1),
					this._backdrop.hide(() => {
						document.body.classList.remove(Si),
			...
			_triggerBackdropTransition() {
				if (
					!f.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented
				) {
					let t =
			...
			_adjustDialog() {
				let t =
					...
					i = 0 < e;
				if (i && !t) {
					let t = l() ? "paddingLeft" : "paddingRight";
					this._element.style[t] = e + "px";
				}
				if (!i && t) {
					let t = l() ? "paddingRight" : "paddingLeft";
					this._element.style[t] = e + "px";
				}
			}
			_resetAdjustments() {
			...
			static jQueryInterface(e, i) {
				return this.each(function () {
					var t = Oi.getOrCreateInstance(this, e);
					if ("string" == typeof e) {
						if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
						t[e](i);
					}
		...
		f.on(
			...
			function (t) {
				let e = h.getElementFromSelector(this);
				["A", "AREA"].includes(this.tagName) && t.preventDefault(),
					f.one(e, Ei, (t) => {
						t.defaultPrevented ||
							f.one(e, Ti, () => {
				...
				t && Oi.getInstance(t).hide(), Oi.getOrCreateInstance(e).toggle(this);
			}
		),
			dt(Oi),
			t(Oi);
			...
			function (t) {
				...
				["A", "AREA"].includes(this.tagName) && t.preventDefault(),
					a(this) ||
						...
						(t = h.findOne(Di)) && t !== e && M.getInstance(t).hide(),
						M.getOrCreateInstance(e).toggle(this));
			}
		),
			f.on(window, "load.bs.offcanvas.data-api", () => {
				for (var t of h.find(Di)) M.getOrCreateInstance(t).show();
			}),
			f.on(window, "resize.bs.offcanvas", () => {
				for (var t of h.find("[aria-modal][class*=show][class*=offcanvas-]"))
		...
		class Bi extends ut {
			...
			toHtml() {
				...
				for (let [t, e] of Object.entries(this._config.content))
					this._setContent(i, e, t);
				let t = i.children[0],
					e = this._resolvePossibleFunction(this._config.extraClass);
				return e && t.classList.add(...e.split(" ")), t;
			}
			_typeCheckConfig(t) {
			...
			_checkContent(t) {
				for (var [e, i] of Object.entries(t))
					super._typeCheckConfig({ selector: e, entry: i }, $i);
			}
			_setContent(t, e, i) {
				i = h.findOne(i, t);
				i &&
					((e = this._resolvePossibleFunction(e))
						? s(e)
							? this._putElementInTemplate(o(e), i)
							: this._config.html
			...
			_maybeSanitize(i) {
				if (this._config.sanitize) {
					...
					let t = new window.DOMParser().parseFromString(n, "text/html"),
						e = [].concat(...t.body.querySelectorAll("*"));
					for (let n of e) {
						let t = n.nodeName.toLowerCase();
						if (Object.keys(o).includes(t)) {
							let e = [].concat(...n.attributes),
								i = [].concat(o["*"] || [], o[t] || []);
							for (let t of e)
								((t, e) => {
									let i = t.nodeName.toLowerCase();
									return e.includes(i)
										? !qi.has(i) || Boolean(Fi.test(t.nodeValue))
										: e
		...
		let Vi = new Set(["sanitize", "allowList", "sanitizeFn"]),
			Ui = "fade",
			Qi = "show",
			Yi = "hide.bs.modal",
			Xi = "hover",
		...
		class tn extends e {
			...
			dispose() {
				clearTimeout(this._timeout),
					f.off(this._element.closest(".modal"), Yi, this._hideModalHandler),
			...
			show() {
				...
				if (this._isWithContent() && this._isEnabled) {
					let t = f.trigger(this._element, this.constructor.eventName("show")),
						e = (
			...
			hide() {
				if (
					...
					if (
						...
						for (var t of [].concat(...document.body.children))
							f.off(t, "mouseover", H);
			...
			_createTipElement(t) {
				...
				return (
					t.setAttribute("id", e), this._isAnimated() && t.classList.add(Ui), t
				);
			}
			setContent(t) {
				(this._newContent = t),
			...
			_setListeners() {
				...
				for (var i of t)
					if ("click" === i)
						...
						f.on(this._element, t, this._config.selector, (t) => {
							...
							(e._activeTrigger["focusin" === t.type ? Gi : Xi] = !0),
								e._enter();
						}),
							f.on(this._element, e, this._config.selector, (t) => {
								var e = this._initializeOnDelegatedTarget(t);
								(e._activeTrigger["focusout" === t.type ? Gi : Xi] =
				...
				(this._hideModalHandler = () => {
					...
					f.on(this._element.closest(".modal"), Yi, this._hideModalHandler);
			}
			_fixTitle() {
			...
			_getConfig(t) {
				...
				for (let t of Object.keys(e)) Vi.has(t) && delete e[t];
				return (
			...
			_getDelegateConfig() {
				var t,
					e,
					i = {};
				for ([t, e] of Object.entries(this._config))
					this.constructor.Default[t] !== e && (i[t] = e);
			...
			static jQueryInterface(e) {
				return this.each(function () {
					var t = tn.getOrCreateInstance(this, e);
					if ("string" == typeof e) {
						if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
						t[e]();
					}
		...
		let en = {
			...
			nn = { ...tn.DefaultType, content: "(null|string|element|function)" };
		class on extends tn {
			static get Default() {
				return en;
			}
		...
		class hn extends e {
			...
			refresh() {
				...
				for (var t of this._observableSections.values())
			...
			_configAfterMerge(t) {
				return (
					(t.target = o(t.target) || document.body),
			...
			_maybeEnableSmoothScroll() {
				this._config.smoothScroll &&
					(f.off(this._config.target, sn),
					f.on(this._config.target, sn, ln, (t) => {
			...
			_initializeTargetsAndObservables() {
				...
				let t = h.find(ln, this._config.target);
				for (var e of t)
					if (e.hash && !a(e)) {
						let t = h.findOne(decodeURI(e.hash), this._element);
						r(t) &&
			...
			_process(t) {
				this._activeTarget !== t &&
					...
					(this._activeTarget = t).classList.add(an),
			...
			_activateParents(t) {
				if (t.classList.contains("dropdown-item"))
					...
					for (var e of h.parents(t, ".nav, .list-group"))
						for (let t of h.prev(
							e,
			...
			_clearActiveClass(t) {
				...
				var e = h.find(ln + "." + an, t);
				for (let t of e) t.classList.remove(an);
			}
			static jQueryInterface(e) {
				return this.each(function () {
		...
		f.on(window, "load.bs.scrollspy.data-api", () => {
			for (var t of h.find('[data-bs-spy="scroll"]')) hn.getOrCreateInstance(t);
		}),
			t(hn);
		let dn = "ArrowRight",
			pn = "ArrowDown",
			...
			bn = `.nav-link${vn}, .list-group-item${vn}, [role="tab"]${vn}, ` + yn;
		P, P, P;
		class _n extends e {
			constructor(t) {
				super(t),
			...
			show() {
				...
				this._elemIsActive(i) ||
					((e = (t = this._getActiveElem())
						? f.trigger(t, "hide.bs.tab", { relatedTarget: i })
						: null),
					f.trigger(i, "show.bs.tab", { relatedTarget: t }).defaultPrevented) ||
			...
			_keydown(e) {
				if (["ArrowLeft", dn, "ArrowUp", pn, fn, "End"].includes(e.key)) {
					e.stopPropagation(), e.preventDefault();
					var i,
						n = this._getChildren().filter((t) => !a(t));
					let t;
					(t = [fn, "End"].includes(e.key)
						? n[e.key === fn ? 0 : n.length - 1]
						: ((i = [dn, pn].includes(e.key)), U(n, e.target, i, !0))) &&
						(t.focus({ preventScroll: !0 }), _n.getOrCreateInstance(t).show());
				}
			}
			_getChildren() {
				return h.find(bn, this._parent);
			}
			_getActiveElem() {
			...
			_getInnerElement(t) {
				return t.matches(bn) ? t : h.findOne(bn, t);
			}
			_getOuterElement(t) {
			...
			static jQueryInterface(e) {
				return this.each(function () {
					var t = _n.getOrCreateInstance(this);
					if ("string" == typeof e) {
						if (void 0 === t[e] || e.startsWith("_") || "constructor" === e)
							throw new TypeError(`No method named "${e}"`);
						t[e]();
		...
		f.on(document, "click.bs.tab", yn, function (t) {
			["A", "AREA"].includes(this.tagName) && t.preventDefault(),
				a(this) || _n.getOrCreateInstance(this).show();
		}),
		...
		class En extends e {
			...
			show() {
				f.trigger(this._element, "show.bs.toast").defaultPrevented ||
					...
					W(this._element),
					this._element.classList.add(wn, xn),
					this._queueCallback(
						() => {
					...
					this._queueCallback(
						() => {
							this._element.classList.add("hide"),
								this._element.classList.remove(xn, wn),
			...
			dispose() {
				this._clearTimeout(),
					this.isShown() && this._element.classList.remove(wn),
					super.dispose();
			}
			isShown() {
			...
			_onInteraction(t, e) {
				...
				e
					? this._clearTimeout()
					: this._element === (t = t.relatedTarget) ||
			...
			static jQueryInterface(e) {
				return this.each(function () {
					var t = En.getOrCreateInstance(this, e);
					if ("string" == typeof e) {
						if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
						t[e](this);
					}
				...
				if (
					...
					return (
						(l = u.validator.normalizeRules(
							...
							((r = l.required),
							delete l.required,
							(l = u.extend({ required: r }, l))),
						l.remote &&
							((r = l.remote),
							delete l.remote,
							(l = u.extend(l, { remote: r }))),
						l
					);
				}
			},
			...
			u.extend(u.validator, {
				...
				prototype: {
								...
								: (this.prepareElement(o),
								  ...
								  (i = this.groups[o.name]) &&
										u.each(this.groups, function (t, e) {
											e === i &&
												t !== o.name &&
												(n = r.validationTargetFor(r.clean(r.findByName(t)))) &&
												n.name in r.invalid &&
												(r.currentElements.push(n), (s = r.check(n) && s));
										}),
								  (e = !1 !== this.check(o)),
								  (s = s && e),
					...
					check: function (e) {
						...
						for (i in (this.abortRequest(e),
						"function" == typeof r.normalizer
							? (o = r.normalizer)
							: "function" == typeof this.settings.normalizer &&
							  (o = this.settings.normalizer),
						o && ((l = o.call(e, l)), delete r.normalizer),
						r)) {
					...
					remote: function (n, o, t, r) {
						...
						return (
							this.settings.messages[o.name] ||
								(this.settings.messages[o.name] = {}),
							(a.originalMessage =
								a.originalMessage || this.settings.messages[o.name][r]),
											...
											!0,
											{
												...
												success: function (t) {
													...
													(s.settings.messages[o.name][r] = a.originalMessage),
														i
															? ((e = s.formSubmitted),
															  (s.toHide = s.errorsFor(o)),
															  (s.formSubmitted = e),
															  s.successList.push(o),
															  (s.invalid[o.name] = !1),
															  s.showErrors())
															: ((e = {}),
															  (t =
				...
				: ((n = u.ajax),
				  (u.ajax = function (t) {
						var e = ("mode" in t ? t : u.ajaxSettings).mode,
							t = ("port" in t ? t : u.ajaxSettings).port;
						return "abort" === e
							? (u.ajaxAbort(t), (o[t] = n.apply(this, arguments)), o[t])
	...
	((t) => {
		...
		function s(t, s) {
			function i() {
				s.scaleColor && c(),
					s.trackColor && l(s.trackColor, s.trackWidth || s.lineWidth, 1);
			}
			var n,
				...
				a =
					(1 < window.devicePixelRatio &&
						...
						(e.style.width = e.style.height = [s.size, "px"].join("")),
						(e.width = e.height = s.size * r),
						o.scale(r, r)),
				...
				c = function () {
					...
					for (var i = 24; 0 < i; --i)
						(t =
							i % 6 == 0
								? ((e = s.scaleLength), 0)
								: ((e = 0.6 * s.scaleLength), s.scaleLength - e)),
							o.fillRect(-s.size / 2 + t, 0, e, 1),
							o.rotate(Math.PI / 12);
					o.restore();
				},
				u =
			...
			(this.getCanvas = function () {
				...
				(this.draw = function (t) {
					var e;
					s.scaleColor || s.trackColor
						? o.getImageData && o.putImageData
							? n
								? o.putImageData(n, 0, 0)
								: (i(), (n = o.getImageData(0, 0, s.size * r, s.size * r)))
							: (this.clear(), i())
						: this.clear(),
						(o.lineCap = s.lineCap),
					...
					var o = Date.now(),
						r =
							...
							function () {
								...
								this.draw(e),
									s.onStep(i, n, e),
									t >= s.animate.duration ? s.onStop(i, n) : u(r);
							}.bind(this));
					u(r);
				}.bind(this));
		}
	...
	((t) => {
		var e = ((n, d, r) => {
			...
			for (gt in ((f = n.lazySizesConfig || n.lazysizesConfig || {}), vt))
				gt in f || (f[gt] = vt[gt]);
			return d && d.getElementsByClassName
				? ((m = d.documentElement),
				  (j = n.HTMLPictureElement),
				  (g = "getAttribute"),
				  (t = n[(o = "addEventListener")].bind(n)),
				  (u = n.setTimeout),
				  (R = n.requestAnimationFrame || u),
				  ...
				  (a = function (t, e) {
						return (
							...
							i[e].test(t[g]("class") || "") && i[e]
						);
				  }),
				  (h = function (t, e) {
						a(t, e) ||
							t.setAttribute("class", (t[g]("class") || "").trim() + " " + e);
				  }),
				  (v = function (t, e) {
						(e = a(t, e)) &&
							t.setAttribute("class", (t[g]("class") || "").replace(e, " "));
				  }),
				  (y = function (e, i, t) {
				  ...
				  (nt = /^img$/i),
				  (ot = /^iframe$/i),
				  (rt = "onscroll" in n && !/(gle|ing)bot/.test(navigator.userAgent)),
				  (D = -1),
				  (st = function (t) {
						return (
							(Z = null == Z ? "hidden" == w(d.body, "visibility") : Z) ||
							!(
				  ...
				  (ct = e(function (e, t, i, n, o) {
						var r, s, a, l, c;
						(s = b(e, "lazybeforeunveil", t)).defaultPrevented ||
							(n && (i ? h(e, f.autosizesClass) : e.setAttribute("sizes", n)),
							(i = e[g](f.srcsetAttr)),
							(n = e[g](f.srcAttr)),
							o && (r = (l = e.parentNode) && N.test(l.nodeName || "")),
							(a = t.firesLoad || ("src" in e && (i || n || r))),
							(s = { target: e }),
							h(e, f.loadingClass),
							a && (clearTimeout(Q), (Q = u(bt, 2500)), y(e, lt, !0)),
							r && F.call(l.getElementsByTagName("source"), Ct),
							i
				  ...
				  ($ = {
						_: function () {
							(Y = r.now()),
								...
								n.MutationObserver
									? new MutationObserver(M).observe(m, {
											childList: !0,
											subtree: !0,
											attributes: !0,
									  })
									: (m[o]("DOMNodeInserted", M, !0),
									  m[o]("DOMAttrModified", M, !0),
									  setInterval(M, 999)),
								t("hashchange", M, !0),
								[
									"focus",
								...
								/d$|^c/.test(d.readyState)
									? Et()
									: (t("load", Et), d[o]("DOMContentLoaded", M), u(Et, 2e4)),
								p.elements.length ? (_t(), x._lsFlush()) : M();
						},
						checkElems: (M = function (t) {
							var e;
							(t = !0 === t) && (O = 33),
								J ||
									((J = !0),
						...
						unveil: (P = function (t) {
							...
							t._lazyRace ||
								...
								o && l.updateElem(t, !0, t.offsetWidth),
								(t._lazyRace = !0),
								z++,
								ct(t, e, o, n, i));
						}),
				  ...
				  (l = {
						_: function () {
							(B = d.getElementsByClassName(f.autosizesClass)), t("resize", U);
						},
						checkElems: (U = W(function () {
							var t,
								e = B.length;
							if (e) for (t = 0; t < e; t++) yt(B[t]);
						})),
						updateElem: yt,
				  }),
				  (c = function () {
						!c.i && d.getElementsByClassName && ((c.i = !0), l._(), $._());
				  }),
				  u(function () {
						f.init && c();
				  }),
			...
			function yt(t, e, i) {
				...
				n &&
					((i = H(t, n, i)),
					(e = b(t, "lazybeforesizes", { width: i, dataAttr: !!e }))
						.defaultPrevented ||
						((i = e.detail.width) && i !== t._lazysizesWidth && V(t, n, e, i)));
			}
			function bt(t) {
			...
			function _t() {
				var t,
					...
					u,
					h = p.elements;
				if ((E = f.loadMode) && z < 8 && (t = h.length)) {
					for (e = 0, D++; e < t; e++)
						if (h[e] && !h[e]._lazyRace)
							if (!rt || (p.prematureUnveil && p.prematureUnveil(h[e])))
								P(h[e]);
							else if (
								(((s = h[e][g]("data-expand")) && (o = +s)) || (o = L),
								l ||
									((l =
										!f.expand || f.expand < 1
								...
								(I = c.bottom) >= r &&
									...
									((T && z < 3 && !s && (E < 3 || D < 4)) ||
										((t, e) => {
											...
											for (
												S -= e, I += e, k -= e, A += e;
												o && (n = n.offsetParent) && n != d.body && n != m;

											)
												(o = 0 < (w(n, "opacity") || 1)) &&
													"visible" != w(n, "overflow") &&
								...
								!n &&
									...
									D < 4 &&
									2 < E &&
									(C[0] || f.preloadAfterLoad) &&
									(C[0] ||
										(!s &&
											(I || A || k || S || "auto" != h[e][g](f.sizesAttr)))) &&
									(i = C[0] || h[e]);
					i && !n && P(i);
				}
			}
			...
			function Ct(t) {
				var e,
					i = t[g](f.srcsetAttr);
				(e = f.customMedia[t[g]("data-media") || t[g]("media")]) &&
					t.setAttribute("media", e),
					i && t.setAttribute("srcset", i);
			}
			function Tt() {
				3 == f.loadMode && (f.loadMode = 2), ut();
			}
			function Et() {
				T ||
					(r.now() - Y < 999
						? u(Et, 999)
						: ((T = !0), (f.loadMode = 3), M(), t("scroll", Tt, !0)));
			}
			function St() {
				var t = mt;
				for (mt = pt.length ? ft : pt, dt = !(ht = !0); t.length; ) t.shift()();
				ht = !1;
			}
			function kt(t, e) {
				ht && !e
					? t.apply(this, arguments)
					: (mt.push(t), dt || ((dt = !0), (d.hidden ? u : R)(St)));
			}
		})(t, t.document, Date);
		(t.lazySizes = e),
	...
	((t, e) => {
		...
		function y(t) {
			if (
				...
				for (
					var r = (o.isBorderBox = "border-box" == e.boxSizing), s = 0;
					s < w;
					s++
				) {
					var a = _[s],
			...
			c =
				...
				(l.getParent = function (t, e) {
					for (; t.parentNode && t != document.body; )
						if (r((t = t.parentNode), e)) return t;
				}),
						...
						: ((this.stagger =
								"number" == typeof (e = e)
									...
									: ((t = (e = e.match(/(^\d*\.?\d*)(\w*)/)) && e[1]),
									  (e = e && e[2]),
									  t.length ? (t = parseFloat(t)) * (p[e] || 1) : 0)),
						  this.stagger);
				}),
	...
	((s, a) => {
		...
		var a = t.jQuery,
			...
			t = ((c.Item = o), (c.LayoutMode = s), c.prototype),
			u =
				((t._create = function () {
		...
		return (
			...
			(t.overlaps = function (t) {
				var e = this.x + this.width,
					...
					n = t.x + t.width;
				return this.x < n && e > t.x && this.y < t.y + t.height && i > t.y;
			}),
				...
				return (
					...
					this.settings.loop ||
						(this.op(i, ">", s[this.minimum()])
							? (o = i = this.minimum())
							: this.op(i, "<", s[this.maximum()]) && (o = i = this.maximum())),
					o
				);
			}),
	...
	((u, e) => {
		...
		(i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
			(i.prototype.fetch = function (t, e) {
				...
				(n = n[6]),
					(this._videos[s] = { type: i, id: n, width: o, height: r }),
					e.attr("data-video", s),
		...
		function d(t, e) {
			f.ev.triggerHandler("mfp" + t, e),
				f.st.callbacks &&
					...
					f.st.callbacks[t].apply(f, Array.isArray(e) ? e : [e]);
		}
		function p(t) {
			return (
			...
			I =
					...
					proto: (t.prototype = {
						...
						open: function (t) {
							if (!1 === t.isObj) {
								...
								(f.items = Array.isArray(t.items) ? t.items : [t.items]),
									(f.index = t.index || 0);
							if (!f.isOpen) {
								(f.types = []),
									(g = ""),
								...
								for (
									var o = c.magnificPopup.modules, n = 0;
									n < o.length;
									n++
								) {
								...
								d("BeforeOpen"),
									...
									f.fixedContentPos
										...
										: f.wrap.css({ top: A.scrollTop(), position: "absolute" }),
									(!1 !== f.st.fixedBgPos &&
								...
								return (
									...
									setTimeout(function () {
										f.content
											? (f._addClassToMFP(E), f._setFocus())
						...
						_close: function () {
							...
							f.bgOverlay.detach(),
								...
								f.st.autoFocusLast &&
									f._lastFocusedEl &&
									c(f._lastFocusedEl).trigger("focus"),
								(f.currItem = null),
								(f.content = null),
								(f.currTemplate = null),
								(f.prevHeight = 0),
						...
						updateSize: function (t) {
							...
							f.isIOS
								? ((e =
								  ...
								  f.wrap.css("height", (e *= window.innerHeight)),
								  (f.wH = e))
								: (f.wH = t || A.height()),
						...
						updateItemHTML: function () {
							var t = f.items[f.index],
								...
								i =
									...
									(f.currItem = t),
									f.currTemplate[e] ||
										(d("FirstMarkupParse", (i = !!f.st[e] && f.st[e].markup)),
						...
						updateStatus: function (t, e) {
							...
							f.preloader &&
								...
								(t = i.status),
								(e = i.text),
								f.st.allowHTMLInStatusIndicator
									? f.preloader.html(e)
									: f.preloader.text(e),
						...
						_checkIfClose: function (t) {
							if (!c(t).closest("." + S).length) {
								var e = f.st.closeOnContentClick,
									i = f.st.closeOnBgClick;
								if (e && i) return !0;
								if (
									!f.content ||
									c(t).closest(".mfp-close").length ||
						...
						_setFocus: function () {
							(f.st.focus ? f.content.find(f.st.focus).eq(0) : f.wrap).trigger(
								"focus"
							);
						},
				...
				(c.fn.magnificPopup = function (t) {
					...
					return (
						"string" == typeof t
							? "open" === t
								? ((e = k ? o.data("magnificPopup") : o[0].magnificPopup),
							...
							: ((t = c.extend(!0, {}, t)),
							  k ? o.data("magnificPopup", t) : (o[0].magnificPopup = t),
							  f.addGroup(o, t)),
						o
					);
				}),
					...
					_getOffset: function (t) {
						var e = (t = t
							...
							t =
								...
								{
									width: t.width(),
									height: (k ? t.innerHeight() : t[0].offsetHeight) - n - i,
								});
						return (
							(D =
								void 0 === D
				...
				c.magnificPopup.registerModule("gallery", {
					...
					proto: {
							...
							r.langDir || (r.langDir = document.dir || "ltr"),
								...
								u("BuildControls" + t, function () {
									...
									1 < f.items.length &&
										...
										((e =
											"rtl" === r.langDir
												? ((n = r.tNext), (t = r.tPrev), (o = "next"), "prev")
												: ((n = r.tPrev), (t = r.tNext), (o = "prev"), "next")),
										(i = r.arrowMarkup),
										(n = f.arrowLeft =
											c(
												i
										...
										"rtl" === r.langDir
											? ((f.arrowNext = n), (f.arrowPrev = o))
											: ((f.arrowNext = o), (f.arrowPrev = n)),
										n.on("click", function () {
						...
						prev: function () {
							...
							(f.direction = !1), (f.index = z(t)), f.updateItemHTML();
						},
						goTo: function (t) {
						...
						_preloadItem: function (t) {
							...
							(t = z(t)),
								f.items[t].preloaded ||
									(d(
										"LazyLoad",
										(e = (e = f.items[t]).parsed ? e : f.parseEl(t))
									),
									"image" === e.type &&
						...
						updateGalleryButtons: function () {
							f.st.gallery.loop ||
								"object" != typeof f.arrowPrev ||
								null === f.arrowPrev ||
								(0 === f.index ? f.arrowPrev.hide() : f.arrowPrev.show(),
								f.index === f.items.length - 1
									? f.arrowNext.hide()
									: f.arrowNext.show());
						},
					},
			...
			proto: {
				initRetina: function () {
					...
					1 < window.devicePixelRatio &&
						...
						(u("ImageHasSize." + P, function (t, e) {
							e.img.css({
								"max-width": e.img[0].naturalWidth / n,
								width: "100%",
							});
						}),
						u("ElementParse." + P, function (t, e) {
	...
	(() => {
		...
		(e.prototype.TYPES = [
			...
			(e.prototype.polylineToPath = function (t) {
				...
				for (e = "M" + n[0], r = 1; r < n.length; r++)
					-1 !== n[r].indexOf(",") && (e += "L" + n[r]);
				return (i.d = e), i;
			}),
			...
			(e.prototype.parseAttr = function (t) {
				for (var e, i = {}, n = 0; n < t.length; n++) {
					if (
						-1 !== this.ATTR_WATCH.indexOf((e = t[n]).name) &&
						-1 !== e.value.indexOf("%")
					)
						throw new Error(
			...
			(o.prototype.mapping = function () {
					...
					this.isInvisible(u) ||
						...
						"non-scaling-stroke" === u.getAttribute("vector-effect")
							? ((a = u.getBoundingClientRect()),
							  (s = u.getBBox()),
							  (a = Math.max(a.width / s.width, a.height / s.height)),
				...
				for (
					l &&
						...
						this.delayUnit = this.delay / (1 < r.length ? r.length - 1 : 1),
	...
	(() => {
		...
		"object" == typeof window &&
			...
			"intersectionRatio" in window.IntersectionObserverEntry.prototype
				...
				: ((m = (() => {
						for (var t = window.document, e = r(t); e; )
							e = r((t = e.ownerDocument));
						return t;
				  })()),
				  (i = []),
				  (v = g = null),
				  ...
				  (t.prototype._computeTargetAndRootIntersection = function (t, e, i) {
						if ("none" != window.getComputedStyle(t).display) {
							for (var n, o, r, s, a = e, l = _(t), c = !1; !c && l; ) {
								var u,
									h,
									d,
									p = null,
								...
								if (
									...
									p &&
										...
										(s = p - f),
										(a =
											0 <= (r = (o = Math.min(u.right, h.right)) - n) && 0 <= s
												? {
														top: f,
														bottom: p,
														left: n,
						...
						for (var t = 0, e = c.length; t < e; t++) {
							...
							l.minWidth && h.outerWidth() <= l.minWidth
								...
								: ((u = !1),
								  ...
								  a.data("pin", {
										pad: s,
										from: (l.containerSelector ? o : n).top - s.top,
										to: o.top + i.height() - a.outerHeight() - s.bottom,
										end: o.top + i.height(),
										parentTop: r.top,
								  }),
							...
							s &&
								...
								n + r.outerHeight() > s.end
									...
									? ("fixed" != r.css("position") &&
											r
												.css({ left: r.offset().left, top: s.pad.top })
												.css("position", "fixed"),
									  l.activeClass && r.addClass(l.activeClass))
									: o <= a
									? (r
											.css({ left: "", top: o - s.parentTop + s.pad.top })
											.css("position", "absolute"),
									  l.activeClass && r.addClass(l.activeClass))
									: (r.css({ position: "", top: "", left: "" }),
									  l.activeClass && r.removeClass(l.activeClass)));
						}
						c = t;
					}
				};
	...
	((i) => {
		var o,
			r = { action: function () {}, runOnLoad: !1, duration: 500 },
			s = !1,
			n = {
				init: function () {
					for (var t = 0; t <= arguments.length; t++) {
		...
		(n.timedAction = function (t, e) {
			...
			var n = function () {
				...
				if (s) {
					var e = new Date() - o;
					if ((t = r.duration - e) <= 0)
						return clearTimeout(s), (s = !1), void r.action();
				}
				i(t);
			};
			(o = new Date()),
				"number" == typeof e && (r.duration = e),
				"function" == typeof t && (r.action = t),
				s || n();
		}),
					...
					t.on("mousemove", function (t) {
						return (
							...
							a.css({
								perspective: c.perspective + "px",
								transformStyle: "preserve-3d",
								transform: "rotateY(" + r + "deg) rotateX(" + s + "deg)",
							}),
							void l.css(
								"background",
								"linear-gradient(" +
	...
	((r, e) => {
		...
		(r.HoverDir = function (t, e) {
			...
			(r.HoverDir.prototype = {
				_init: function (t) {
					(this.options = r.extend(!0, {}, r.HoverDir.defaults, t)),
						(this.transitionProp =
				...
				_applyAnimation: function (t, e, i) {
					(r.fn.applyStyle = this.support ? r.fn.css : r.fn.animate),
						t.stop().applyStyle(e, r.extend(!0, [], { duration: i + "ms" }));
				},
			}),
				...
				return (
					"string" == typeof t
						...
						: this.each(function () {
								i
									? i._init()
									: (i = r.data(this, "hoverdir", new r.HoverDir(t, this)));
						  }),
					i
				);
			});
			...
			(e = o.$wrapper =
				...
				"detect" === h
					? ((n = function (t) {
					  ...
					  p('<img src="' + (i = s) + '.gif">').on("load", d),
					  p('<img src="' + i + '.jpg">').on("load", d),
					  p('<img src="' + i + '.jpeg">').on("load", d),
					  p('<img src="' + i + '.png">').on("load", d))
					: "none" !== h &&
					  e.css("background-image", "url(" + s + "." + h + ")"),
				"static" === l.css("position") && l.css("position", "relative"),
				l.prepend(e),
				(t =
					"object" == typeof r
						? (r.mp4 &&
								(a += '<source src="' + r.mp4 + '.mp4" type="video/mp4">'),
						  r.webm &&
								(a += '<source src="' + r.webm + '.webm" type="video/webm">'),
						  r.ogv &&
								(a += '<source src="' + r.ogv + '.ogv" type="video/ogg">'),
				...
				return (
					this.each(function () {
						(i = p.data(this, n)) && i.destroy(),
							((i = new s(this, t, e)).index = p.vide.lookup.push(i) - 1),
							p.data(this, n, i);
					}),
					this
				);
	...
	((t) => {
		...
		function n(j, l) {
			function t(t) {
				if (
					!(
						!0 === k.data(zt + "_intouch") ||
						0 < at(t.target).closest(l.excludedElements, k).length
					)
				) {
					var e,
						i,
					...
					if (
						...
						return (
							...
							i
								? (I = i.length)
								: !1 !== l.preventDefaultEvents && t.preventDefault(),
							(E = b = y = null),
							(C = 1),
							(T = x = w = _ = v = 0),
							((t = {})[lt] = a(lt)),
							...
							Z(),
							d(0, n),
							!i || I === l.fingers || l.fingers === Ct || u()
								? ((rt = p()),
								  2 == I && (d(1, i[1]), (w = x = et(O[0].start, O[1].start))),
								  (l.swipeStatus || l.pinchStatus) && (e = c(o, A)))
								: (e = !1),
							!1 === e
								? (c(o, (A = At)), e)
								: (l.hold &&
										(P = setTimeout(
											at.proxy(function () {
												k.trigger("hold", [o.target]),
													l.hold && (e = l.hold.call(k, o, o.target));
											}, this),
											l.longTapThreshold
										)),
								  s(!0),
			...
			function e(t) {
				...
				if (A !== kt && A !== At && !h()) {
					...
					if (
						((L = p()),
						n && (I = n.length),
						l.hold && clearTimeout(P),
						(A = St),
						2 == I &&
							(0 == w
								? (d(1, n[1]), (w = x = et(O[0].start, O[1].start)))
								: (K(n[1]),
								  (x = et(O[0].end, O[1].end)),
								  O[0].end,
								  O[1].end,
								  (E = C < 1 ? pt : dt)),
							(C = ((x / w) * 1).toFixed(2)),
							(T = Math.abs(w - x))),
						I === l.fingers || l.fingers === Ct || !n || u())
					) {
						(y = it(o.start, o.end)), (b = it(o.last, o.end));
						var r,
							s = t,
							n = b;
						if (!1 !== l.preventDefaultEvents)
							if (l.allowPageScroll === ft) s.preventDefault();
							else {
								var a = l.allowPageScroll === mt;
								switch (n) {
									case lt:
										((l.swipeLeft && a) || (!a && l.allowPageScroll != wt)) &&
											s.preventDefault();
										break;
									case ct:
										((l.swipeRight && a) || (!a && l.allowPageScroll != wt)) &&
											s.preventDefault();
										break;
									case ut:
										((l.swipeUp && a) || (!a && l.allowPageScroll != xt)) &&
											s.preventDefault();
										break;
									case ht:
										((l.swipeDown && a) || (!a && l.allowPageScroll != xt)) &&
											s.preventDefault();
								}
							}
						(t = o.start),
							...
							(_ = tt()),
							(n = v),
							(t = y) != ft && ((n = Math.max(n, J(t))), (S[t].distance = n)),
							(i = c(e, A)),
							(l.triggerOnTouchEnd && !l.triggerOnTouchLeave) ||
								((t = !0),
								l.triggerOnTouchLeave &&
									((r = {
										left: (r = (n = at((n = this))).offset()).left,
									...
									(t =
										...
										n.y > o.top &&
										n.y < o.bottom)),
								!l.triggerOnTouchEnd && t
									? (A = q(St))
									: l.triggerOnTouchLeave && !t && (A = q(kt)),
								A != At && A != kt) ||
								c(e, A);
					} else c(e, (A = At));
					!1 === i && c(e, (A = At));
			...
			function i(t) {
				...
				if (n) {
					if (n.length && !h())
						return (e = i), (z = p()), (st = e.touches.length + 1), !0;
				...
				return (
					...
					H() || !F()
						? c(i, (A = At))
						: l.triggerOnTouchEnd || (!1 === l.triggerOnTouchEnd && A === St)
						? (!1 !== l.preventDefaultEvents &&
								!1 !== t.cancelable &&
								t.preventDefault(),
						  c(i, (A = kt)))
			...
			function o() {
				(x = w = rt = L = I = 0), Z(), s(!(C = 1));
			}
			function R(t) {
				t = t.originalEvent || t;
				l.triggerOnTouchLeave && c(t, (A = q(kt)));
			}
			function N() {
				k.off(f, t),
					k.off(g, o),
			...
			function q(t) {
				...
				return (
					!i || o
						? (e = At)
						: !n || t != St || (l.triggerOnTouchEnd && !l.triggerOnTouchLeave)
						? !n && t == kt && l.triggerOnTouchLeave && (e = At)
						: (e = kt),
					e
				);
			}
			function c(t, e) {
				...
				return (
					...
					G() && X() && !1 !== i
						? (i = r(t, e, bt))
						: _ > l.longTapThreshold && v < Tt && l.longTap && !1 !== i
						? (i = r(t, e, _t))
						: (1 !== I && It) ||
						  !(isNaN(v) || v < l.threshold) ||
						  !Y() ||
						  !1 === i ||
						  (i = r(t, e, yt)),
					e === At && o(),
			...
			function r(t, e, i) {
				...
				if (i == gt) {
					if (
						(k.trigger("swipeStatus", [e, y || null, v || 0, _ || 0, I, O, b]),
						l.swipeStatus &&
							!1 ===
								(n = l.swipeStatus.call(
									k,
									t,
									e,
									y || null,
					...
					if (e == kt && B()) {
						if (
							(clearTimeout(M),
							clearTimeout(P),
							k.trigger("swipe", [y, v, _, I, O, b]),
							l.swipe && !1 === (n = l.swipe.call(k, t, y, v, _, I, O, b)))
						)
							return !1;
						switch (y) {
							case lt:
								k.trigger("swipeLeft", [y, v, _, I, O, b]),
									l.swipeLeft && (n = l.swipeLeft.call(k, t, y, v, _, I, O, b));
								break;
							case ct:
								k.trigger("swipeRight", [y, v, _, I, O, b]),
									l.swipeRight &&
										(n = l.swipeRight.call(k, t, y, v, _, I, O, b));
								break;
							case ut:
								k.trigger("swipeUp", [y, v, _, I, O, b]),
									l.swipeUp && (n = l.swipeUp.call(k, t, y, v, _, I, O, b));
								break;
							case ht:
								k.trigger("swipeDown", [y, v, _, I, O, b]),
									l.swipeDown && (n = l.swipeDown.call(k, t, y, v, _, I, O, b));
						}
					}
				}
				if (i == vt) {
					if (
						(k.trigger("pinchStatus", [e, E || null, T || 0, _ || 0, I, C, O]),
						l.pinchStatus &&
							!1 ===
								(n = l.pinchStatus.call(
									k,
									t,
									e,
									E || null,
					...
					if (e == kt && $())
						switch (E) {
							case dt:
								k.trigger("pinchIn", [E || null, T || 0, _ || 0, I, C, O]),
									l.pinchIn &&
										(n = l.pinchIn.call(
											k,
											t,
								...
								break;
							case pt:
								k.trigger("pinchOut", [E || null, T || 0, _ || 0, I, C, O]),
									l.pinchOut &&
										(n = l.pinchOut.call(
											k,
											t,
				...
				return (
					i == yt
								  ...
								  (M = setTimeout(
										at.proxy(function () {
											(D = null),
												...
												l.tap && (n = l.tap.call(k, t, t.target));
										}, this),
						...
						? (e !== At && e !== kt) ||
						  ...
						  l.doubleTap && (n = l.doubleTap.call(k, t, t.target)))
						: i != _t ||
						  (e !== At && e !== kt) ||
						  (clearTimeout(M),
						  (D = null),
						  k.trigger("longtap", [t.target]),
						  l.longTap && (n = l.longTap.call(k, t, t.target))),
					n
				);
			}
			function F() {
				var t = !0;
				return (t = null !== l.threshold ? v >= l.threshold : t);
			}
			function H() {
				var t = !1;
				return (t =
					null !== l.cancelThreshold && null !== y
						? J(y) - v >= l.cancelThreshold
						: t);
			}
			function W() {
			...
			function U() {
				return I === l.fingers || l.fingers === Ct || !It;
			}
			function Q() {
				return 0 !== O[0].end.x;
			}
			...
			function h() {
				var t = !1;
				return (t = z && p() - z <= l.fingerReleaseThreshold ? !0 : t);
			}
			function s(t) {
				k &&
					(!0 === t
						? (k.on(nt, e), k.on(ot, i), m && k.on(m, R))
						: (k.off(nt, e, !1), k.off(ot, i, !1), m && k.off(m, R, !1)),
					k.data(zt + "_intouch", !0 === t));
			}
			function d(t, e) {
				var i = {
					start: { x: 0, y: 0 },
			...
			function K(t) {
				var e = void 0 !== t.identifier ? t.identifier : 0,
					i = O[e] || null;
				return (
					((i = null === i ? d(e, t) : i).last.x = i.end.x),
					(i.last.y = i.end.y),
			...
			function et(t, e) {
				var i = Math.abs(t.x - e.x),
					t = Math.abs(t.y - e.y);
				return Math.round(Math.sqrt(i * i + t * t));
			}
			function it(t, e) {
				var i, n;
				return (
			...
			var l = at.extend({}, l),
				n = It || Lt || !l.fallbackToMouseEvents,
				f = n
					? Lt
						? Ot
							? "MSPointerDown"
				...
				ot = n
					? Lt
						...
						: "touchend"
					: "mouseup",
				m = !n || Lt ? "mouseleave" : null,
				g = Lt ? (Ot ? "MSPointerCancel" : "pointercancel") : "touchcancel",
				v = 0,
				y = null,
				b = null,
				_ = 0,
		...
		var lt = "left",
			...
			Ot = window.navigator.msPointerEnabled && !window.PointerEvent && !It,
			Lt = (window.PointerEvent || window.navigator.msPointerEnabled) && !It,
			zt = "TouchSwipe";
				...
				return function (i) {
					return (
						...
						this.each(function () {
							var t,
								e = at(this);
							e.data(zt) || ((t = new n(this, i)), e.data(zt, t));
						})
					);
	...
	((t) => {
		...
		function s(t, e) {
			(this.$element = r(t)),
				(this.options = r.extend({}, s.DEFAULTS, this.dataOptions(), e)),
				this.init();
		}
		(s.DEFAULTS = {
			from: 0,
			...
			(r.fn.countTo = function (o) {
				return this.each(function () {
					...
					(e && "object" != typeof o) ||
						(e && e.stop(), t.data("countTo", (e = new s(this, i)))),
						e[n].call(e);
				});
			});
	}),
				...
				return (
					...
					"function" == typeof r.getBoundingClientRect
						? ((r = r.getBoundingClientRect()),
						  (s = c
								? 0 <= r.top - h.top && r.top < d + h.top
								: 0 <= r.top && r.top < d),
						  (a = c
								? 0 < r.bottom - h.top && r.bottom <= d + h.top
								: 0 < r.bottom && r.bottom <= d),
						  (o = c
								? 0 <= r.left - h.left && r.left < l + h.left
								: 0 <= r.left && r.left < l),
						  (r = c
								? 0 < r.right - h.left && r.right < l + h.left
								: 0 < r.right && r.right <= l),
						  (s = t ? s || a : s && a),
						  (a = t ? o || r : o && r),
						  "both" === i
			...
			t =
				...
				(u._apply = function (t, e) {
					...
					return (
						...
						u._maintainScroll &&
							s(window).scrollTop((i / n) * s("html").outerHeight(!0)),
						this
					);
				}),
					...
					(d.isPlainObject(arguments[0])
						...
						: (e =
								1 === arguments.length && "boolean" === d.type(arguments[0])
									? arguments[0]
									: ((o = arguments[0]), (r = arguments[1]), arguments[2])),
					(o = o || d.noop),
					(r = r || d.noop),
					(e = !!e),
	...
	((h) => {
		fontSpy = function (t, e) {
			...
			function r() {
				a.callback(),
					i.addClass(a.fontClass),
					a && a.success && a.success(),
					l.remove();
			}
			function s() {
				setTimeout(u, a.delay), (a.timeOut = a.timeOut - a.delay);
			}
			var t = {
					font: t,
				...
				a = h.extend(t, e),
				l = h("<span>" + a.testString + a.glyphs + "</span>")
					.css("position", "absolute")
					.css("top", "-9999px")
					.css("left", "-9999px")
					...
					.css("fontSize", "250px"),
				c = (n.append(l), l.outerWidth()),
				u =
					(l.css("fontFamily", a.font + "," + a.testFont),
					function () {
						var t = l.outerWidth();
						(c !== t ? r : a.timeOut < 0 ? o : s)();
					});
			u();
		};
	})(jQuery),
	((t, e) => {
		...
		function o(n, o, r, t) {
			if ((void 0 === r && (r = function () {}), void 0 === t && (t = {}), !n))
			...
			if (Array.isArray(t) || "number" == typeof t)
				return (
					...
					(e = new IntersectionObserver(function (t, e) {
						...
						t &&
							((t.isInViewport = t.isIntersecting && t.intersectionRatio >= s),
							(t.isInViewport ? o : r)(t, i, n));
					}, i)).observe(n),
					function () {
						return e.unobserve(n);
					}
			...
			return this.each(function () {
				...
				if ("string" == typeof I)
					...
					O.each(a, function (t) {
						...
						(r = "up" === a.direction || "down" === a.direction),
							...
							? ((m = l.height()),
							  ...
							  a.startVisible && !a.duplicated
									...
									: (a.duration =
											((parseInt(g, 10) + parseInt(m, 10)) / parseInt(m, 10)) *
											a.duration))
							: ((s = l.find(".js-marquee:first").width() + a.gap),
							  (n = l.width()),
							  a.startVisible && !a.duplicated
									? ((a._completeDuration =
											((parseInt(s, 10) + parseInt(n, 10)) / parseInt(n, 10)) *
											a.duration),
									  (a.duration =
											(parseInt(s, 10) / parseInt(n, 10)) * a.duration))
									: (a.duration =
											((parseInt(s, 10) + parseInt(n, 10)) / parseInt(n, 10)) *
											a.duration)),
									...
									r
										...
										? (2 < c &&
												i.css(
													"transform",
													"translateX(" +
														("left" === a.direction ? 0 : "-" + s + "px") +
														")"
												),
										  (o = {
												transform:
													"translateX(" +
													("left" === a.direction ? "-" + s + "px" : 0) +
													")",
										  }))
										: a.startVisible
										? 2 === c
